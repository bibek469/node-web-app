...
| <a name="input_cluster-name"></a> [cluster-name](#input\_cluster-name) | n/a | `string` | `"ping-pong-demo"` | no |
...
| <a name="input_node-group-name"></a> [node-group-name](#input\_node-group-name) | n/a | `string` | `"ping-pong-cdn-node-group"` | no |
| <a name="input_role-eks-demo-node"></a> [role-eks-demo-node](#input\_role-eks-demo-node) | n/a | `string` | `"ping-pong-cdn-eks-demo-node"` | no |
| <a name="input_vpc-eks-tag-name"></a> [vpc-eks-tag-name](#input\_vpc-eks-tag-name) | n/a | `string` | `"ping-pong-cdn-eks-demo-tag-name"` | no |
